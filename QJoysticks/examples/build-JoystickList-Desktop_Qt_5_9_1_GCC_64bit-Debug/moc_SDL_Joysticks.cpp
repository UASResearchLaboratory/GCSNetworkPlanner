...
void SDL_Joysticks::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SDL_Joysticks *_t = static_cast<SDL_Joysticks *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (SDL_Joysticks::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SDL_Joysticks::countChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SDL_Joysticks::*_t)(const QJoystickPOVEvent & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SDL_Joysticks::POVEvent)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SDL_Joysticks::*_t)(const QJoystickAxisEvent & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SDL_Joysticks::axisEvent)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (SDL_Joysticks::*_t)(const QJoystickButtonEvent & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SDL_Joysticks::buttonEvent)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject SDL_Joysticks::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SDL_Joysticks.data,
      qt_meta_data_SDL_Joysticks,  qt_static_metacall, nullptr, nullptr}
};
...
void *SDL_Joysticks::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SDL_Joysticks.stringdata0))
        return static_cast<void*>(const_cast< SDL_Joysticks*>(this));
